package top.abmcar.easyvar.command;
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        if (strings.length == 2) {
            if (strings[0].equals("show")) {
                ...
                MessageSender.sendMessage(commandSender, nowString2);
                return true;
            }
        }
        if (strings.length == 3) {
        ...
        if (strings.length == 7) {
            ...
            if (strings[1].equalsIgnoreCase("set")) {
                ...
                String nowString = scriptName + "创建成功, \n" + "当 " + varType + "的变量" + varName + " 大于等于" + varValue + "时以" + (isOp ? "OP" : "玩家") + "权限执行命令.";
                MessageSender.sendMessage(commandSender, nowString);
                return true;
            }
        }
